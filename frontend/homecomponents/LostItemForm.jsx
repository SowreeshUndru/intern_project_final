...
const LostItemForm = () => {
  ...
  // Use Object.entries to loop over formData
  Object.entries(formData).forEach(([key, value]) => {
    formDataToSend.append(key, value);
  });

  axiosinstance.post('/user/lostform', formDataToSend)
    .then((res) => {
      if (res.status === 200) {
        ...
        alert("itemfound and this chat been deployed in notification with * mark");
        console.log(res);
      }
       else {
  ...
  return (
    <div className=" -mb-15  lostitem scrollhandle  text-black h-full overflow-y-auto bg-[#E8E1B5] flex items-center justify-center p-4 rounded-xl">
      <form
